...
const NOTIFICATION_TYPES: Record<string, { label: string; variant: Variant }> = {
  ...
  PAYMENT_FAILED: { label: "Payment unsuccessful", variant: "danger" },
  PROGRAMME_PAYMENT_CONFIRMED: { label: "Payment confirmed", variant: "success" },
  PROGRAMME_PAYMENT_FAILED: { label: "Payment unsuccessful", variant: "danger" },
  PROGRAMME_PAYMENT_INITIATED: { label: "Payment started", variant: "primary" },
  PROGRAMME_INVOICE_ISSUED: { label: "Invoice issued", variant: "warning" },
  PROGRAMME_INVOICE_OVERDUE: { label: "Invoice overdue", variant: "danger" },
  PROGRAMME_ENTITLEMENT_ACTIVATED: { label: "Programme access active", variant: "success" },

...
type PatientSettingsPageViewProps = Readonly<{
  initialSettings: PatientSettings;
}>;

const settingsStorageKey = "glycolink.patient.settings";
...
export function PatientSettingsPageView({
  ...
  useEffect(() => {
    ...
    try {
      const parsedSettings = JSON.parse(rawSettings) as PatientSettings;
  ...
  function persistSettings(nextSettings: PatientSettings) {
    setSettings(nextSettings);
    window.localStorage.setItem(settingsStorageKey, JSON.stringify(nextSettings));
    setSettingsMessage("Communication preferences updated.");
  }
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <ToggleRow
            ...
            description="Receive appointment reminders and platform updates by email."
          ...
          <ToggleRow
            ...
            description="Receive important reminders and alerts by SMS."
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          ...
          <Button
            ...
            onClick={() => setAccountMessage("Account deactivation request recorded in this demo.")}
          >
            Deactivate Account
          </Button>
